...
const ResumeUI = () => {
  const { resume, selectedBuilding, setSelectedBuilding, zoomToBuilding } =
    useResume();
  ...
  const getInterestIcon = (category: string) => {
    if (category === "sports") {
      return <FaBasketballBall className="w-5 h-5 text-gray-500" />;
    }
    if (category === "hobby") {
      return <FaPalette className="w-5 h-5 text-gray-500" />;
    }
    return <FaLightbulb className="w-5 h-5 text-gray-500" />;
  };
    ...
    <>
      ...
      <button
        ...
        className={`absolute top-6 z-50 bg-white text-gray-700 hover:text-gray-900 hover:bg-gray-50 transition-all duration-300 p-2.5 rounded-full shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500 ${
          isLeftPanelVisible
            ? selectedBuilding ? "left-[536px]" : "left-[436px]"
            : "left-4"
        }`}
            ...
            <div className="px-4 py-3 bg-white border-b border-gray-200">
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="w-12 h-12 rounded-full flex-shrink-0 shadow-sm overflow-hidden">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      if (parent) {
                        parent.className = 'w-12 h-12 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex-shrink-0 flex items-center justify-center text-white text-lg font-semibold shadow-sm';
                ...
                <div className="flex flex-col min-w-0 flex-1">
                  ...
                  <p className="text-xs text-gray-600 leading-tight truncate">{resume.title}</p>
                </div>
              </div>
              ...
              {selectedExperience && (
                <div className="px-6 py-6">
                  <div className="mb-6 w-full">
                    <span className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 text-blue-700 text-xs font-medium rounded-md mb-4">
